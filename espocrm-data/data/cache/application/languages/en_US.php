...
Leave the field empty if you need to apply the exception only for specific users.',
  ...
  'CCompaias' => [
    ...
    'links' => [],
    'labels' => [
      'Create CCompaias' => 'Crear Compañia'
    ]
  ],
  'CCotizaciones' => [
    'fields' => [],
    'links' => [],
    'labels' => [
      'Create CCotizaciones' => 'Create Cotización'
    ]
  ],
  'CEntidades' => [
    'fields' => [],
    'links' => [],
    'labels' => [
      'Create CEntidades' => 'Create Entidad'
    ]
  ],
  'CExpediente' => [
    'fields' => [],
    'links' => [],
    'labels' => [
      'Create CExpediente' => 'Create Expediente'
    ]
  ],
  'CPliza' => [
    'fields' => [],
  ...
  'CReclamos' => [
    ...
    'links' => [],
    'labels' => [
      'Create CReclamos' => 'Create Reclamo'
    ],
    'options' => [
      'estadoDeReclamo' => [
        'Resuelto' => 'Resuelto',
